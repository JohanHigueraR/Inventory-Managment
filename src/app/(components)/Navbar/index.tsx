    ...
    <div className="flex justify-between items-center w-full mb-7 ">
      ...
      <div className="flex justify-center items-center gap-5">
        ...
        <div className="relative">
          <input
            type="search"
            className="pl-10 pr-4 py-2 w-50 md:w-80 border-2 border-[var(--color-gray-300)] bg-[var(--color-bg)] rounded-lg focus:outline-none focus:border-[var(--color-primary)] text-[var(--color-text)]"
            placeholder="Search..."
          />
